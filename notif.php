<div class="container m-5">
            ...
            <div class="row mb-3 text-dark">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" placeholder="Masukkan Obat Pilihan Anda" value="<?=$dataobat[$id][0]?>" readonly>
              </div>
            </div>
            <div class="row mb-3 text-dark">
              <label for="input5" class="col-sm-2 col-form-label ms-4">Harga Obat</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" id="hargaobat" placeholder="Harga Obat" value="<?=$dataobat[$id][2]?>" readonly>
              </div>
            </div>
            <div class="row mb-3 text-dark">
